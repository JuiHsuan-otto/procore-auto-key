...
BANNED_REPLACEMENTS = {
    ...
    "嚴重影響日常行程": "影響用車安排",
    "我們深知": "遇到",
    "極致核心 ProCore 了解這種焦慮": "遇到這種狀況會先確認車況",
    "了解這種焦慮": "會先確認車況",
    "焦慮與不便": "不便",
    "專門提供": "可協助安排",
    "緊急到場服務": "到場處理",
    "專業到場服務": "到場處理",
    "讓車主在": "協助車主在",
    "避免不必要的拖吊費用與等待時間": "先判斷是否需要拖車與後續安排",
    "免去拖車煩惱": "先判斷是否需要拖車",
    "拖車煩惱": "拖車安排",
    "即時協助": "協助確認",
    "迅速提供": "安排",
    ...
    "致力於提供": "提供",
    "高效、可靠": "清楚",
    "大幅節省您的時間與拖車費用": "先評估是否需要拖車",
    "直接前往您的車輛停放地點": "依車輛停放地點評估到場",
    "成功為車主解決": "協助車主處理",
    "大幅": "",
    "精準判斷": "判斷",
    "精準報價": "估價方向",
...
def case_prompt(identity: dict, intake: dict) -> str:
    ...
    return (
        ...
        "- 文章角度要服務潛在客戶的下一步決策：他會擔心能不能到場、要不要拖車、需要準備什麼、是否安全、是否會洩漏資料、如何先估報價方向。\n"
        ...
        "- 禁止假情緒與假見證：不要寫「我們了解這種焦慮、嚴重影響日常行程、車主滿意、充分信心、安心重新駕駛」這類素材沒有提供的感受或評價。\n"
        "- 品牌名「極致核心 ProCore」每篇正文最多自然出現 2 次，不要每段都重複品牌名。\n"
